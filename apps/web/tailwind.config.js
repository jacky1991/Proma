/**
 * Web 端 Tailwind 配置（自包含）
 *
 * M4 迭代 11 步骤 3：renderer 已物理搬迁至 apps/web/src/renderer，本配置不再 import
 * apps/electron/tailwind.config.js，而是内联与其完全一致的主题配置（darkMode/safelist/
 * theme.extend/plugins），使 Web 构建完全脱离 apps/electron 目录（AC-5）。
 * 如需调整主题，请与 apps/electron/tailwind.config.js 保持同步（步骤 5 删除 electron 后归一）。
 */
